...
export default function paginate({
  ...
  idAttribute = 'id',
  selectResponseResults = action => action.payload.results,
  selectResponseTotal = action => action.payload.totalResults
}) {
  ...
  const updatePagination = createReducer(defaultState, {
    ...
    [successType](state, action) {
      ...
      const totalEntities = selectResponseTotal(action);
